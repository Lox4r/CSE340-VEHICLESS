...
router.post('/add-classification', invVal.checkClassification, utilities.handleErrors(invController.addClassification));

router.get('/add-inventory', requireAdminOrEmployee, utilities.handleErrors(invController.showAddInventoryForm));
router.post('/add-inventory', requireAdminOrEmployee, invVal.newInventoryRules(), invVal.checkInventoryData, utilities.handleErrors(invController.processAddInventoryForm));

router.get('/edit/:inv_id', utilities.handleErrors(invController.editInventoryView));
router.post('/update', invVal.newInventoryRules(), invVal.checkUpdateData, utilities.handleErrors(invController.updateInventory));
